...
// The GCU address two sets of 64 palettes. The first set is used for sprites,
// and the second set for backgrounds.
// When a text plane is present, it generally shares palette groups with the
// backgrounds.

#define SAI_PAL555(r, g, b)  (((r)<<0)|((g)<<5)|(b<<10))
